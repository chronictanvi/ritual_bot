...
print(f"wake up in your {random.choice(adjectives)} {random.choice(places)}. {random.choice(verbs)} your {random.choice(nouns)} {random.choice(adverbs)}. {random.choice(moveVerbs)} to your {random.choice(places)}.")
